  ...
  return (
    <article className='flex h-[340px] w-64 overflow-hidden rounded-[28px] bg-white shadow-[0_2px_2px_4px_rgba(0,0,0,0.25)] transition-all duration-300 active:duration-75 cursor-pointer hover:scale-105 active:scale-90 active:rotate-[3deg] hover:brightness-95'>
      <div className='flex w-full flex-col'>
        ...
        <div className='flex h-[110px] flex-col justify-between bg-primary px-5 py-4 text-white'>
          <p className='line-clamp-2 text-[40px] font-bold leading-tight'>{fileName}</p>
          <div className='flex items-center justify-between text-[38px] font-medium leading-none'>
            <span>{sizeMb}</span>
            <span>{format}</span>
          </div>
        </div>
